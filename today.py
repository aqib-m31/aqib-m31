...
USER_NAME = os.environ['USER_NAME'] # 'aqib-m31'
...
if __name__ == '__main__':
    """
    Aqib Javid Bhat (aqib-m31)
    """
    print('Calculation times:')
    # define global variable for owner ID and calculate user's creation date
    # e.g {'id': 'MDQ6VXNlcjYzODUyMjEz'} and 2020-04-17T11:11:29Z for username 'aqib-m31'
    user_data, user_time = perf_counter(user_getter, USER_NAME)
    OWNER_ID, acc_date = user_data
    formatter('account data', user_time)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2003, 10, 30))
